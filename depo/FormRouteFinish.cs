...
namespace depo
{
    public partial class FormRouteFinish : Form
    {
        public FormRouteFinish()
        {
            InitializeComponent();
        }
        ...
        private void FormRouteFinish_Load(object sender, EventArgs e)
        {
            LoadDataGrid();
        }
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                command.CommandText = $"delete from `route_finish` where `id`={selectedId}";
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                command.CommandText = $"insert into `route_finish` (`Id`,`Name`) values (0,'{textBox1.Text}')";
                command.ExecuteNonQuery();
